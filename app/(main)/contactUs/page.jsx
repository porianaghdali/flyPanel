  ...
  const list = [
    {
      title: "تلفن",
      id: 1,
      icon: <PhoneCall color="#D3AE60" size={41} />,
      value: "۰۲۱-۴۴۳۲۸۸۲۲",
    },
    {
      title: "ایمیل",
      id: 2,
      icon: <Mail color="#D3AE60" size={41} />,
      value: "rahito@gmail.com",
    },
    {
      title: "آدرس",
      id: 3,
      icon: <Map color="#D3AE60" size={41} />,
      value: "خیابان ولیعصر، تهران",
    },
  ];
  return (
    <div className="px-[5%]">
            ...
            return (
              <div key={item.id} className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-[#FDFBF7] text-xl font-extrabold">
                    {item.title}
                  </p>
                  <p className="text-[#FDFBF7] text-lg font-normal">
                    {item.value}
                  </p>
                </div>
              </div>
