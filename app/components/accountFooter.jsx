  ...
  return (
    <>
              ...
              {links.map((item) => {
                return (
                  <Link
                    key={item.id}
                    href=""
                    className=" text-[#1C1C1F] font-normal text-base"
                  >
                    {item.title}
                  </Link>
                );
      ...
      <div className="  px-[5%] flex justify-between mb-12">
        <p className=" text-[#767676] text-sm font-medium">قوانین و مقررات استفاده</p>
        <p className=" text-[#767676] text-sm font-medium">حق کپی رایت، محفوظ به راهیتو است.</p>
      </div>
    </>
  );
}
